  ...
  const [hover, setHover] = useState(false);
    ...
    return (
      <div className="h-auto flex flex-col items-center justify-center  bg-opacity-10 bg-no-repeat bg-center my-6">
          ...
          <p className="mx-5 md:w-1/2 md:mx-auto pb-8 font-extralight">Nuestros productos están disponibles para profesionales de la estética y también para uso personal. Si está interesado en hacer una compra, puede explorar nuestro catálogo en línea y realizar su pedido de manera fácil y rápida.</p>
          <p className="mx-5 md:w-1/2 md:mx-auto pb-8 font-extralight">Si tiene alguna pregunta o necesita ayuda para seleccionar los productos adecuados, no dude en contactarnos</p>
