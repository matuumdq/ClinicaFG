        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 content-center place-items-center h-auto gap-12 py-8 ">
          {tratamientos.map((tratamiento) => (
            <div key={tratamiento.id} className="flex flex-col pb-5 gap-3 border border-gray-400/40 w-full min-h-[15vh] h-auto rounded-md shadow-md">
              ...
              <p className="mx-4 font-thin italic line-clamp-3">{tratamiento.explanation}</p>
              <a href={msg} target="_blank" rel="noreferrer" className="font-light bg-amber-400/60 mx-auto px-2 py-1 rounded-md hover:scale-105 ease-in duration-300 text-purple-700">Mas Información</a>
            </div>
          ))}
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 content-center place-items-center h-auto gap-12 py-8 ">
          {cursos.map((curso) => (
            <div key={curso.id} className="flex flex-col cursor-default pb-5 gap-3 border border-gray-400/40 w-full min-h-[15vh] h-auto rounded-md shadow-md">
              ...
              <p className="mx-4 font-thin italic line-clamp-3">{curso.explanation}</p>
              <a href={msgcurso} target="_blank" rel="noreferrer" className="font-light bg-amber-400/60 mx-auto px-2 py-1 rounded-md hover:scale-105 ease-in duration-300 text-purple-700">Mas Información</a>
            </div>
          ))}
        </div>
      </div>
