...
const Carousel = () => {
	...
	const slides = [
		{
			...
			imagen: "https://damian-barera.github.io/ClinicaFG/images/modelo3.jpg",
			nombre: "Neil Smith",
		...
		},
		{
			id: 1,
			testimonio:
				"Suelo acomodar mis visitas a la clínica en algunos de mis días libres. El tiempo para mi es oro y en Cicec son muy conscientes de ello. Velocidad y efectividad en un solo lugar.",
			imagen: "https://damian-barera.github.io/ClinicaFG/images/modelo2.jpg",
			nombre: "Tom Cruise",
			trabajo: "Actor",
		},
		{
			...
			imagen: "https://damian-barera.github.io/ClinicaFG/images/modelo1.jpg",
			nombre: "Harry Mason",
			trabajo: "Modelo",
		},
	];
	...
	return (
		<div className="relative mx-auto sm:px-4 pt-8 bg-gradient-to-b from-yellow-500/20 to-white">
								...
								>
									<section className="rounded-lg bg-primary-300/70 py-8 px-12 w-full md:flex md:gap-6">
										<img
											alt={slide.nombre}
											src={slide.imagen}
											className="aspect-square mx-auto w-auto md:max-w-xs mb-5 md:mb-0 rounded-tr-xl rounded-bl-xl h-44 md:h-auto max-h-56 object-cover"
										/>
					...
					<div className="flex flex-col md:flex-row justify-center md:justify-between items-center mt-2">
						<div className="block">
							<button
								...
								className="p-2 sm:p-7 rounded-full hover:scale-90 text-slate-950 ease-in-out duration-200 absolute inset-y-0 left-0 sm:left-10 md:left-8"
							>
						...
						<div className="block">
							<button
								...
								className="p-2 sm:p-6 rounded-full hover:scale-90 text-slate-950 ease-in-out duration-200 absolute inset-y-0 right-0 sm:right-10 md:right-8"
							>
